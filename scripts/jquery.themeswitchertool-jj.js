...
$.fn.themeswitcher = function(settings){
	...
	var switcherpane = $(content).find('div').removeAttr('id');
	...
	function updateCSS(locStr){
		...
		if ($.browser.msie) { $(cssLink).clone().appendTo('head');	}	//JJ: IE does not redraw when the <link> source is local (if it's absolute and external it does redraw).
	}	
